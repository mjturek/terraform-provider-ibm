...
- `pi_image_bucket_access` - (Optional, String) Indicates if the bucket has public or private. The default value is `public`.
  - `pi_image_bucket_access` is required with `pi_image_bucket_name`
